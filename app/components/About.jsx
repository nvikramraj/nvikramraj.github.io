    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <div className='flex-1'>
          ...
          I am currently on the lookout for Full-time positions starting July 2026. Please feel free to reach out if you think I would be a good fit for your team!
          </p>
